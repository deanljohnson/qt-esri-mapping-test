...
function(GET_INSTALL_DIR OUT_VAR DESC_VAR)
  ...
  set(ArcGISRuntime_VER_MAJ_MIN ${ArcGISRuntime_FIND_VERSION_MAJOR}.${ArcGISRuntime_FIND_VERSION_MINOR}.${ArcGISRuntime_FIND_VERSION_PATCH})
  if(${CMAKE_HOST_SYSTEM_NAME} STREQUAL Windows)
    # change 1
    #set(INI_PATH $ENV{ALLUSERSPROFILE}/EsriRuntimeQt/ArcGIS\\ Runtime\\ SDK\\ for\\ Qt\\ ${ArcGISRuntime_VER_MAJ_MIN}.ini)
    set(INI_PATH "$ENV{ALLUSERSPROFILE}\\EsriRuntimeQt\\ArcGIS Runtime SDK for Qt ${ArcGISRuntime_VER_MAJ_MIN}.ini")
  else()
    # change 2
    #set(INI_PATH $ENV{HOME}/.config/EsriRuntimeQt/ArcGIS\\ Runtime\\ SDK\\ for\\ Qt\\ ${ArcGISRuntime_VER_MAJ_MIN}.ini)
    set(INI_PATH "$ENV{HOME}/.config/EsriRuntimeQt/ArcGIS Runtime SDK for Qt ${ArcGISRuntime_VER_MAJ_MIN}.ini")
  endif()

  message(STATUS "INI_PATH: ${CMAKE_SYSTEM_PROCESSOR}")
